namespace Chess.Players
{
	...
	public class AIPlayer : Player
	{
		...
		public AIPlayer(Board board, AISettings settings, GameMode mode)
		{
			...
			if (settings.useModeData)
			{
				book = new OpeningBook(settings.modesData.Find(n => n.Mode == mode).Data.text);
			}
		}
		...
		public override void NotifyTurnToMove()
		{
			...
			if (settings.useModeData && board.plyCount <= settings.maxBookPly)
			{
